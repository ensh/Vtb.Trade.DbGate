...
{
    public class MarginInstrumentRatesExternalRequestAdapter : RequestAdapter
    {
        public MarginInstrumentRatesExternalRequestAdapter() : base(EntityType.MarginInstrumentRates) { ((CE)this).Fields.Capacity = 5; }
        public MarginInstrumentRatesExternalRequestAdapter(CE data) : base(
            (data.EntityType == EntityType.MarginInstrumentRates) ? data : new CE { EntityType = EntityType.MarginInstrumentRates })
        { }

        public static implicit operator MarginInstrumentRatesExternalRequestAdapter(CE entity) => new MarginInstrumentRatesExternalRequestAdapter(entity);
        ...
        public override string CommandText { get => @"olb.vtb_get_margin_instrument_rates"; }
