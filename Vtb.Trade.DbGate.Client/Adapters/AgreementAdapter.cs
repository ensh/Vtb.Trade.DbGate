...
namespace Vtb.Trade.DbGate.Client
{
    ...
    public class AGR : IdentitySelectorContext { }

    public class AgreementAdapter : CE_Adapter
    {
        public AgreementAdapter() : base(EntityType.Agreement) { ((CE)this).Fields.Capacity = 12; }
        public AgreementAdapter(CE data) : base(
        ...
        public static implicit operator AgreementAdapter(CE entity)
        => new AgreementAdapter(entity);
